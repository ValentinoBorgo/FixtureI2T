...
public class UsuarioDTO {
    ...
    @Size(min = 1)
    private Collection<Autoridad> roles;
    ...
    public UsuarioDTO(@NotNull(message = "Ingrese un nombre") @Size(min = 1) String nombre,
            ...
            @NotNull(message = "Ingrese un rol") @Size(min = 1) Collection<Autoridad> roles,
    ...
    public Collection<Autoridad> getRoles() {
        return roles;
    }

    public void setRoles(Collection<Autoridad> roles) {
        this.roles = roles;
    }
